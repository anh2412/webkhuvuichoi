...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th9 25, 2024 lúc 04:02 PM
...
('Tàu Hải Tặc', 'long@gmail.com', 4, 250000, 1000000, '2024-06-15');
...
(2, 'long@gmail.com', 'long', 'Nguyen Duy Long', '0834239906', 'Ha Noi', 0),
(5, 'l@gmail.com', '1', 'Lê Thị Ly', '0987654321', 'Hà Nội', 0);
...
--
ALTER TABLE `am_thuc_va_mua_sam`
  MODIFY `MaAmThuc` int(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `taikhoan`
  MODIFY `MaTaiKhoan` int(250) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
